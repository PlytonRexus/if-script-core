const Keywords = {
  ...
  PROP_FULL_TIMER_OUTCOME: '@fullTimerOutcome',
  PROP_IF_TITLE: '@storyTitle',
  PROP_MAX_ITERATIONS: '@maxIterations',
  PROP_MAX_CALL_DEPTH: '@maxCallDepth',
  PROP_STATUS_BAR: '@statusBar',
  PROP_THEME: '@theme',
  PROP_STORY_AMBIENCE: '@storyAmbience',
  PROP_STORY_AMBIENCE_VOLUME: '@storyAmbienceVolume',
  PROP_STORY_AMBIENCE_LOOP: '@storyAmbienceLoop',
  PROP_STORY_AMBIENCE_FADE_IN_MS: '@storyAmbienceFadeInMs',
  PROP_STORY_AMBIENCE_FADE_OUT_MS: '@storyAmbienceFadeOutMs',
  ...
  PROP_SCENE_AMBIENCE: '@sceneAmbience',
  PROP_SCENE_AMBIENCE_VOLUME: '@sceneAmbienceVolume',
  PROP_SCENE_AMBIENCE_LOOP: '@sceneAmbienceLoop',
  PROP_SCENE_AMBIENCE_FADE_IN_MS: '@sceneAmbienceFadeInMs',
  PROP_SCENE_AMBIENCE_FADE_OUT_MS: '@sceneAmbienceFadeOutMs',
  ...
  PROP_SECTION_TIMER_OUTCOME: '@timerOutcome',
